...
`npm run gate -- M6` · raw: `gate.json` · browser: `browser.json` · screenshot: `dragging.png`

The raw output and screenshots named above are written to `artifacts/M6/` when the gate
