...
`npm run gate -- M7` · raw: `gate.json` · browser: `browser.json` · screenshot: `preview.png`

The raw output and screenshots named above are written to `artifacts/M7/` when the gate
