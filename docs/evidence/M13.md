...
`npm run gate -- M13` · raw: `gate.json` · browser: `browser.json` · screenshot: `tour.png`

The raw output and screenshots named above are written to `artifacts/M13/` when the gate
