...
`npm run gate -- M4` · raw: `gate.json` · browser: `browser.json` · screenshot: `desktop.png`

The raw output and screenshots named above are written to `artifacts/M4/` when the gate
