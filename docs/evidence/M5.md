...
`npm run gate -- M5` · raw: `gate.json` · browser: `browser.json` · screenshot: `floating.png`

The raw output and screenshots named above are written to `artifacts/M5/` when the gate
